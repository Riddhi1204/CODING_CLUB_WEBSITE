export const EVENT_CONFIG = {
  university: {
    ...
    logoText: "SBU", // Fallback if image is missing
  },
  club: {
    name: "SBU CODING CLUB",
  },
  event: {
  ...
  dignitaries: {
    heading: "IN THE ESTEEMED PRESENCE OF",
    primary: [
      {
        designation: "Honourable Director General",
        name: "Prof. Gopal Pathak Sir",
      },
      {
        designation: "Honourable Vice Chancellor",
        name: "Prof. C. Jeganathan Sir",
      },
    ],
    secondary: [
      {
        designation: "Respected Registrar",
        name: "Prof. SB Dandin Sir",
      },
    ],
    deans: [
      {
